    ...
    struct e82576_device *dev)
{
    ...
    dev_info(&dev->pdev->dev, "RX DMA: ");
    dev_info(&dev->pdev->dev, "RDBAL=0x%08x ", e82576_read_reg(dev, E1000_RDBAL(0)));
    dev_info(&dev->pdev->dev, "RDBAH=0x%08x ", e82576_read_reg(dev, E1000_RDBAH(0)));
    dev_info(&dev->pdev->dev, "RDLEN=%u ", e82576_read_reg(dev, E1000_RDLEN(0)));
    dev_info(&dev->pdev->dev, "RDH=%u ", e82576_read_reg(dev, E1000_RDH(0)));
...
//      */
//     e82576_write_reg(dev, E1000_RCTL, E1000_RCTL_EN | E1000_RCTL_BAM | E1000_RCTL_SECRC);

//     /*
//      * Enable transmitter.
//      */
//     e82576_write_reg(dev, E1000_TCTL, E1000_TCTL_EN | E1000_TCTL_PSP);
//     e82576_flush(dev);
// }
